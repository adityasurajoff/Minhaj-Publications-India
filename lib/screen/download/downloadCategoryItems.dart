...
class DownloadCategoryScreen extends StatefulWidget {
  final int categoryName;
  DownloadCategoryScreen(this.categoryName);
  @override
  _DownloadCategoryScreenState createState() => _DownloadCategoryScreenState();
}

class _DownloadCategoryScreenState extends State<DownloadCategoryScreen> {
  ...
  _getSearchDownload() async {
    ...
    http.get(
      "$rootlink/wp-json/wpdm/v1/packages?categories=[${widget.categoryName}]&number_of_posts=32",
      headers: {
        ...
        title: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                border: InputBorder.none, hintText: "Search books"),
          ),
        ),
        actions: [
          IconButton(
